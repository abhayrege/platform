...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <select class="selectpicker" data-style="btn-default" data-live-search="true">
                                ...
                                <option>WordPress Expert</option>
            ...
            <div class="section lb">
                <div class="container">
                    <div class="section-title text-center clearfix">
                        <h4>Looking for Expert Freelancers?</h4>
                    ...
                    <div class="loadmorebutton text-center clearfix">
                        <a href="#" class="btn btn-primary" id="loadMore">Load More Freelancers</a>
                    </div><!-- end loadmore -->
                </div><!-- end container -->
            </div><!-- end section -->
    ...
    ********************************************** -->
    ...
    <!-- MAP & CONTACT -->
    <script src="js/map-freelancer.js"></script>
