            ...
            <div class="parallax section parallax-off" style="background-image:url('upload/fbg.jpg');">
                <div class="container">
                    <div class="page-title text-center">
                        ...
                        <p class="lead">Hello there, this is your custom single job tagline message.</p>
                    </div>
                </div><!-- end container -->
            </div><!-- end section -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-7 col-xs-12">
                                    ...
                                    <small>
                                        <span>Publisher : <a href="#">PCH Company</a></span> 
                                    ...
                                    <a href="#contactmodal" role="button" data-toggle="modal" class="btn btn-primary btn-custom">Apple For Job</a> 
                                </div><!-- end col -->
                            ...
                            <div class="post-single-job">
                                <div class="single-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <h5 class="small-title">Education Requirements</h5>
