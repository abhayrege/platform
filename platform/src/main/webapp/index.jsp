...
<jsp:include page="pageMenu"></jsp:include> 
                    ...
                    <div class="all-jobs job-listing clearfix">
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_06.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="post-media">
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_01.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="post-media">
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_02.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="post-media">
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_03.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="post-media">
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_04.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
                        ...
                        <div class="job-tab">
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="post-media">
                                    <a href="job-single.html"><img src="<c:url value="/resources/upload/job_05.jpg" />" alt="" class="img-responsive img-thumbnail"></a>
                                    </div><!-- end media -->
                                </div><!-- end col -->
            ...
            <%-- <div class="section wb">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="<c:url value="/resources/upload/about.jpg" />" alt="" class="img-responsive img-rounded">
                        </div>
                    ...
                    <div class="row whoweare">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="<c:url value="/resources/upload/about_01.jpg" />" alt="" class="img-responsive img-rounded">
                                </div>
                                <div class="col-md-6">
                                    <img src="<c:url value="/resources/upload/about_02.jpg" />" alt="" class="img-responsive img-rounded">
                                </div>
                            </div><!-- end row -->
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="<c:url value="/resources/upload/about_03.jpg" />" alt="" class="img-responsive img-rounded">
                                </div>
                                <div class="col-md-6">
                                    <img src="<c:url value="/resources/upload/about_04.jpg" />" alt="" class="img-responsive img-rounded">
                                </div>
                            </div><!-- end row -->
                    ...
                    <div class="row freelancer-list">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_09.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_08.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_07.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_06.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_05.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="freelancer-wrap row-fluid clearfix">
                                <div class="col-md-3 text-center">
                                    <div class="post-media">
                                        <img class="img-responsive" src="<c:url value="/resources/upload/testi_04.png" />" alt="">
                                    </div>
                                </div><!-- end col -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="widget clearfix">
                                <div class="widget-title">
                                    <img class="flogo" src="<c:url value="/resources/images/flogo.png" />" alt="">
                                </div><!-- end widget-title -->
                                ...
                                <div class="text-widget">   
                                    ...
                                    <div class="mobileicons">
                                        <a href="#"><img src="<c:url value="/resources/images/mobile_01.png" />" alt=""></a>
                                        <a href="#"><img src="<c:url value="/resources/images/mobile_02.png" />" alt=""></a>
                                    </div>
                                </div><!-- end text-widget -->
                            </div>
                        </div><!-- end col -->
            ...
            <div class="contactme hidden-xs">
                <a href="page-contact.html">
                    <img src="<c:url value="/resources/upload/me.jpg" />" class="img-circle" alt="" data-toggle="tooltip" data-placement="top" title="Need Help?">
